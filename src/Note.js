    ...
    return( <div className="row" >
            ...
            <div className="card medium">
              ...
              <div className="card-action">
                ...
                <div className="right">
                    <span onClick ={ () => {this.props.deleteNote(this.props.note.id)}} className="btn-floating btn-medium waves-effect waves-light red"><i className="material-icons">delete</i></span>
